...
template <typename PointType>
typename
pcl::PointCloud<PointType>::Ptr Sf_ConverterCTToPCL<PointType>::getCloudOriginal() const {
...
template <typename PointType>
void Sf_ConverterCTToPCL<PointType>::iterateCloudAndConvert(const CT_AbstractPointCloudIndex* index ) {
...
template <typename PointType>
void Sf_ConverterCTToPCL<PointType>::compute() {
...
template<typename PointType>
void Sf_ConverterCTToPCL<PointType>::mergeSubCloudsToVector(CT_Grid3D_Sparse<int>* indices,
...
template<typename PointType>
void Sf_ConverterCTToPCL<PointType>::downScale(float range,
