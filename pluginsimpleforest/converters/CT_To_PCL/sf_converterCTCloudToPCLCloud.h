...
/**
 * @brief The SF_ConverterCTCloudToPCLCloud class Class to convert a CT input Cloud to a PCL cloud. The PCL point type
 * is a templated parameter. The Cloud is shifted to the origin (0,0,0) during conversion.
 */
class SF_ConverterCTCloudToPCLCloud:
...
private:
    ...
    /**
     * @brief initialize Allocates memory for templated \ref m_cloudOut, as well as for \ref m_CTIndices. Computes \ref _translation.
     */
    void initialize();
};
