...
public:
    ...
    void setCoudIn(std::pair<pcl::PointCloud<PointType>::Ptr,std::vector<size_t> > cloudIn);
...
template<typename PointType>
void SF_AbstractCloud::setCoudIn(std::pair<pcl::PointCloud::Ptr, std::vector<size_t> > cloudIn)
{
    m_cloudIn = cloudIn;
}
