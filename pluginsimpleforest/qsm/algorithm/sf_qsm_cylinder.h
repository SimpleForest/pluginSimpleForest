...
struct QSMDetectionCylinder {
    ...
    QSMDetectionCylinder(float distance, pcl::ModelCoefficients::Ptr circleA) {
        _distance = distance;
        _circleA   = circleA;
    }

    QSMDetectionCylinder(float distance, pcl::ModelCoefficients::Ptr circleA, pcl::ModelCoefficients::Ptr circleB) {
