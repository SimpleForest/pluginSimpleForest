...
void SF_SphereFollowingRasterSearch::compute() {
  ...
  m_params._sphereFollowingParams.m_optimizationParams[0]
      ._euclideanClusteringDistance = 2 * (desc.mean() + 2 * desc.sd());
  m_params._sphereFollowingParams.m_optimizationParams[0]._epsilonSphere =
      (desc.mean() + 2 * desc.sd());
  std::vector<SF_ParamSpherefollowingBasic<SF_PointNormal>> paramVec =
      paramVector();
  size_t index = 0;
  std::for_each(
      paramVec.begin(), paramVec.end(),
      [this, &index](SF_ParamSpherefollowingBasic<SF_PointNormal> &params) {
  ...
  std::sort(paramVec.begin(), paramVec.end(),
            [](SF_ParamSpherefollowingBasic<SF_PointNormal> params1,
               SF_ParamSpherefollowingBasic<SF_PointNormal> params2) {
              return params1._modelCloudError < params2._modelCloudError;
            });
  m_paramVec = paramVec;
}

void SF_SphereFollowingRasterSearch::setParams(
    const SF_ParamSpherefollowingBasic<SF_PointNormal> &params) {
  m_params = params;
}

void SF_SphereFollowingRasterSearch::setCloud(
...
SF_SphereFollowingRasterSearch::paramVector() {
  ...
  for (size_t a = 0; a < 5; a++) {
    ...
    switch (a) {
    case 0:
      paramsA._sphereFollowingParams.m_optimizationParams[0]
          ._sphereRadiusMultiplier = 1.75;
      break;
    case 1:
      paramsA._sphereFollowingParams.m_optimizationParams[0]
          ._sphereRadiusMultiplier = 2.25;
      break;
    case 2:
      paramsA._sphereFollowingParams.m_optimizationParams[0]
          ._sphereRadiusMultiplier = 2.75;
      break;
    case 3:
      paramsA._sphereFollowingParams.m_optimizationParams[0]
          ._sphereRadiusMultiplier = 3.25;
      break;
    case 4:
      paramsA._sphereFollowingParams.m_optimizationParams[0]
          ._sphereRadiusMultiplier = 4;
      break;
    default:
      break;
    }
    for (size_t b = 0; b < 4; b++) {
      ...
      switch (b) {
      case 0:
        paramsB._sphereFollowingParams.m_optimizationParams[0]
            ._euclideanClusteringDistance *= 0.5;
        break;
      case 1:
        paramsB._sphereFollowingParams.m_optimizationParams[0]
            ._euclideanClusteringDistance *= 1;
        break;
      case 2:
        paramsB._sphereFollowingParams.m_optimizationParams[0]
            ._euclideanClusteringDistance *= 4;
        break;
      case 3:
        paramsB._sphereFollowingParams.m_optimizationParams[0]
            ._euclideanClusteringDistance *= 8;
        break;
      default:
        break;
      }
      for (size_t c = 0; c < 4; c++) {
        ...
        switch (c) {
        case 0:
          paramsC._sphereFollowingParams.m_optimizationParams[0]
              ._epsilonSphere *= 0.5;
          break;
        case 1:
          paramsC._sphereFollowingParams.m_optimizationParams[0]
