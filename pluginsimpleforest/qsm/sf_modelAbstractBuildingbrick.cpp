...
size_t Sf_ModelAbstractBuildingbrick::getIndex() const {
    return _indexVector;
}
...
float Sf_ModelAbstractBuildingbrick::getDistance(const pcl::PointXYZINormal &point) {
    Eigen::Vector3f p(point.x, point.y, point.z);
    return getDistance(p);
}
...
size_t Sf_ModelAbstractBuildingbrick::getID() const {
    return _ID;
}

std::shared_ptr<SF_ModelAbstractSegment> Sf_ModelAbstractBuildingbrick::getSegment() {
    return _segment.lock();
}

void Sf_ModelAbstractBuildingbrick::setSegment(std::shared_ptr<SF_ModelAbstractSegment> segment) {
    _segment = segment;
}

void Sf_ModelAbstractBuildingbrick::setID(const size_t &ID) {
    _ID = ID;
}
...
Eigen::Vector3f Sf_ModelAbstractBuildingbrick::getEnd() const {
    return _end;
}

std::shared_ptr<Sf_ModelAbstractBuildingbrick> Sf_ModelAbstractBuildingbrick::getParent() {
    std::shared_ptr<Sf_ModelAbstractBuildingbrick> parent = getSegment()->getParentBuildingBrick(_indexVector);
    return parent;
}

std::vector<std::shared_ptr<Sf_ModelAbstractBuildingbrick> > Sf_ModelAbstractBuildingbrick::getChildren() {
