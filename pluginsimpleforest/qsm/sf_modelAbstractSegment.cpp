...
void SF_ModelAbstractSegment::setParent(const std::weak_ptr<SF_ModelAbstractSegment> &parent) {
    _parent = parent;
}
...
std::vector<std::shared_ptr<Sf_ModelAbstractBuildingbrick> > SF_ModelAbstractSegment::getBuildingBricks() const {
...
int SF_ModelAbstractSegment::getID() const {
    return _ID;
}

void SF_ModelAbstractSegment::setID(int ID) {
    _ID = ID;
}

std::vector<std::shared_ptr<SF_ModelAbstractSegment> > SF_ModelAbstractSegment::getChildSegments() const
{
...
void SF_ModelAbstractSegment::addChild(std::shared_ptr<SF_ModelAbstractSegment> child) {
    child->setParent(shared_from_this());
    _childSegments.push_back(child);
}

void SF_ModelAbstractSegment::addBuildingBrick(std::shared_ptr<Sf_ModelAbstractBuildingbrick> buildingBrick) {
...
std::vector<std::shared_ptr<Sf_ModelAbstractBuildingbrick> > SF_ModelAbstractSegment::getChildBuildingBricks(const size_t index) {
...
std::shared_ptr<Sf_ModelAbstractBuildingbrick>  SF_ModelAbstractSegment::getParentBuildingBrick(const size_t index) {
