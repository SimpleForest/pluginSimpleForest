...
public:
    ...
    std::shared_ptr<SF_Model_Abstract_Buildingbrick> getParent();
    std::vector<std::shared_ptr<SF_Model_Abstract_Buildingbrick> > getChildren();
    ...
    std::shared_ptr<SF_Model_Abstract_Segment> getSegment();
    void setSegment(std::shared_ptr<SF_Model_Abstract_Segment> segment);
};
