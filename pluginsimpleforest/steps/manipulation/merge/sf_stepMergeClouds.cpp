...
SF_StepMergeClouds::SF_StepMergeClouds(CT_StepInitializeData& dataInit) : SF_AbstractFilterBinaryStep(dataInit) {}

SF_StepMergeClouds::~SF_StepMergeClouds() {}

QString
SF_StepMergeClouds::getStepDescription() const
{
  return tr("Merge clouds from two groups.");
}

QString
SF_StepMergeClouds::getStepDetailledDescription() const
{
...
QString
SF_StepMergeClouds::getStepURL() const
{
  return tr("");
}
...
QStringList
SF_StepMergeClouds::getStepRISCitations() const
{
...
void
SF_StepMergeClouds::createPostConfigurationDialogExpert(CT_StepConfigurableDialog* configDialog)
{
...
void
SF_StepMergeClouds::createPostConfigurationDialogBeginner(CT_StepConfigurableDialog* configDialog)
{
  configDialog->addText("Two clouds stored in two different result groups are "
                        "selected. The first cloud of group 1 ist merged with "
                        "the first cloud of group 2 and so on.");
...
void
SF_StepMergeClouds::createOutResultModelListProtected()
{
  CT_OutResultModelGroupToCopyPossibilities* resModelw = createNewOutResultModelToCopy(DEF_IN_RESULT);
  if (resModelw != NULL) {
    resModelw->addItemModel(DEF_IN_GRP1, _outCloud, new CT_Scene(), tr("Merged Clouds"));
  }
}

void
SF_StepMergeClouds::adaptParametersToExpertLevel()
{}

void
SF_StepMergeClouds::writeOutputPerScence(CT_ResultGroup* outResult, size_t i)
{}

void
SF_StepMergeClouds::writeOutput(CT_ResultGroup* outResult)
{}

void
SF_StepMergeClouds::compute()
{
...
void
SF_StepMergeClouds::writeLogger()
{}

void
SF_StepMergeClouds::createParamList(CT_ResultGroup* outResult)
{}
