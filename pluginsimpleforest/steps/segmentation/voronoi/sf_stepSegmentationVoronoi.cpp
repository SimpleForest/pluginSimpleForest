...
QString SF_StepSegmentationVoronoi::getStepURL() const { return tr(""); }
...
QStringList SF_StepSegmentationVoronoi::getStepRISCitations() const {
  ...
  _risCitationList.append(QString(
      "TY  - CONF\n"
...
void SF_StepSegmentationVoronoi::createPostConfigurationDialog() {
  ...
  configDialog->addDouble(
      ...
      _zFactor);
  configDialog->addDouble(
      "If an input point has a distance to its closest seed point smaller   ",
