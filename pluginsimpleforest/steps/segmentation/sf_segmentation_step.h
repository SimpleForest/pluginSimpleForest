...
protected:
    ...
    void downscale(pcl::PointCloud<pcl::PointXYZI>::Ptr cloudPCL, float voxelSize, pcl::PointCloud<pcl::PointXYZI>::Ptr cloudPCLDownscaled);
    void initializeIndexVec(size_t size, std::vector<CT_PointCloudIndexVector *>& indexVec);
    void createPCLCloud(const QString &clusterGrpStr, const QString& clusterStr, CT_ResultGroup* out_result, pcl::PointCloud<pcl::PointXYZI>::Ptr cloudPCL, std::vector<size_t>& indices, float factor);
    void fillIndexVec(pcl::PointCloud<pcl::PointXYZI>::Ptr cloudPCL, std::vector<CT_PointCloudIndexVector *>& indexVec,
