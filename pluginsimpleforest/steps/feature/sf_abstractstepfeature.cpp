/****************************************************************************
    ...
    sf_abstractstepfeature.cpp is part of SimpleForest - a plugin for the
    Computree platform.
...
SF_AbstractStepFeature::SF_AbstractStepFeature(CT_StepInitializeData& dataInit) : SF_AbstractStep(dataInit) {}
