...
template <typename PointType>
void  SF_StatisticalOutlierFilter<PointType>::compute(const SF_ParamStatisticalOutlierFilter<PointType> &params) {
...
template <typename PointType>
void SF_StatisticalOutlierFilter<PointType>::statisticalOutlierFilter(SF_ParamStatisticalOutlierFilter<PointType> stdParams,
...
template <typename PointType>
void SF_StatisticalOutlierFilter<PointType>::statisticalOutlierFilterIteratively(SF_ParamStatisticalOutlierFilter<PointType> stdParams) {
...
template <typename PointType>
void SF_StatisticalOutlierFilter<PointType>::iterate(SF_ParamStatisticalOutlierFilter<PointType> params,
                                                     typename pcl::PointCloud<PointType>::Ptr cloud) {
