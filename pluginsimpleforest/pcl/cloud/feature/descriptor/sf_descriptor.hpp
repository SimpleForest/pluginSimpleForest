...
SF_Descriptor<PointType>::SF_Descriptor(typename pcl::PointCloud<PointType>::Ptr cloudIn) : _cloudIn(cloudIn)
{}

template<typename PointType>
float
SF_Descriptor<PointType>::mean() const
{
  return m_mean;
}
...
template<typename PointType>
float
SF_Descriptor<PointType>::sd() const
{
  return m_sd;
}
...
template<typename PointType>
void
SF_Descriptor<PointType>::setParameters(int k)
{
  m_k = k;
}
...
template<typename PointType>
void
SF_Descriptor<PointType>::computeFeatures()
{
